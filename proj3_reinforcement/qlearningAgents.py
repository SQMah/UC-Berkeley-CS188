...
class QLearningAgent(ReinforcementAgent):
    ...
    def __init__(self, **args):
        "Values are found with a tuple of type (state, action)"
    ...
    def computeActionFromQValues(self, state):
        ...
        if not legal:
            return None
        best_val, best_action = float("-inf"), []
        for action in legal:
...
class ApproximateQAgent(PacmanQAgent):
    ...
    def update(self, state, action, nextState, reward):
        ...
        for feat in features:
            feature_val = features[feat]
            self.getWeights()[feat] = self.getWeights()[feat] + self.alpha * difference * feature_val
